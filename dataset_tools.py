...
set_to_idx = {"train": 0, "eval": 1, "val": 1, "validation": 1, "test": 2}
...
parser.add_argument(
    "--dataset_path", type=str, default="data/CelebAMask-HQ/CelebA-HQ-img"
)
parser.add_argument(
    "--annotations",
    type=str,
    default="data/CelebAMask-HQ/CelebAMask-HQ-attribute-anno.txt",
)
parser.add_argument(
    "--partitions", type=str, default="data/CelebAMask-HQ/list_eval_partition.txt"
)
parser.add_argument(
    "--mapping", type=str, default="data/CelebAMask-HQ/CelebA-HQ-to-CelebA-mapping.txt"
)
parser.add_argument(
    "--attribute",
    nargs="+",
    type=str,
    default=None,
    help="Which attribute to extract followed by label. Ex: Smiling -1",
)
parser.add_argument(
    "--set", type=str, default="test", help="From which dataset to extract"
)
