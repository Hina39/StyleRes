...
EXCLUDE_DICT_FFHQ = {
    0: [[1, 2, 3], [250, 100, 100], [2, 10]],
    1: [[0, 2, 3], [200, 50, 100], [2, 8]],
    2: [[0, 1, 3], [200, 100, 250], [1, 4]],
    3: [[0, 2], [100, 300], [4, 10]],
}
...
class GradManipulator:
    ...
    def optimize_latent(
        self, w, num_steps, learning_rate, edit, direction, **unused_kwargs
    ):
        ...
        for l_i, l in enumerate(w):
            ...
            for s in range(num_steps):
                ...
                fz_dz_target = torch.autograd.grad(
                    outputs=predictions[c_to_optimize],
